...
def parse_args():
    ...
    parser.add_argument('--model_dir', default=os.path.join('models_16', 'DnCNN_sigma25'), help='directory of the model')
    parser.add_argument('--model_name', default='model_090.pth', type=str, help='the model name')
    parser.add_argument('--result_dir', default='results_16', type=str, help='directory of test dataset')
