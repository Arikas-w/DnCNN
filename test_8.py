...
def parse_args():
    ...
    parser.add_argument('--model_dir', default=os.path.join('models_8', 'DnCNN_sigma25'), help='directory of the model')
    parser.add_argument('--model_name', default='model_090.pth', type=str, help='the model name')
    parser.add_argument('--result_dir', default='results_8', type=str, help='directory of test dataset')
